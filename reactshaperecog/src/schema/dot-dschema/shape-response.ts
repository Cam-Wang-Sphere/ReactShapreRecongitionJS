...
static addDidHit(builder:flatbuffers.Builder, didHit:boolean) {
...
static createShapeResponse(builder:flatbuffers.Builder, sessionId:number, didHit:boolean):flatbuffers.Offset {
