...
(function (Message) {
    ...
    Message[Message["TIMPlayerInput"] = 37] = "TIMPlayerInput";
    Message[Message["TIMMappedAreaAdd"] = 38] = "TIMMappedAreaAdd";
    Message[Message["TIMMappedAreaUpdate"] = 39] = "TIMMappedAreaUpdate";
    Message[Message["TIMMappedAreaRemoved"] = 40] = "TIMMappedAreaRemoved";
    Message[Message["TIMInteractableData"] = 41] = "TIMInteractableData";
    Message[Message["TIMInteractableUpdate"] = 42] = "TIMInteractableUpdate";
    Message[Message["TIMInteractableDestroyed"] = 43] = "TIMInteractableDestroyed";
    Message[Message["TIMHitEvent"] = 44] = "TIMHitEvent";
    Message[Message["TIMInputInteractable"] = 45] = "TIMInputInteractable";
    Message[Message["TIMPlayerInputInteractable"] = 46] = "TIMPlayerInputInteractable";
    Message[Message["AdminSetBotCount"] = 47] = "AdminSetBotCount";
    Message[Message["AdminSetInputType"] = 48] = "AdminSetInputType";
    Message[Message["AdminStartGame"] = 49] = "AdminStartGame";
    Message[Message["AdminSkipPhase"] = 50] = "AdminSkipPhase";
    Message[Message["AdminModifyAsteroidSpeed"] = 51] = "AdminModifyAsteroidSpeed";
    Message[Message["AdminModifyAsteroidHealth"] = 52] = "AdminModifyAsteroidHealth";
    Message[Message["AdminSetStartingPhase"] = 53] = "AdminSetStartingPhase";
