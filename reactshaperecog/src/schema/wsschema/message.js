...
var button_request_js_1 = require("../wsschema/button-request.js");
var button_response_js_1 = require("../wsschema/button-response.js");
...
var slash_request_js_1 = require("../wsschema/slash-request.js");
var slash_response_js_1 = require("../wsschema/slash-response.js");
...
(function (Message) {
    ...
    Message[Message["ClientLoginRequest"] = 9] = "ClientLoginRequest";
    Message[Message["ClientLoginResponse"] = 10] = "ClientLoginResponse";
    Message[Message["MediaPlaneLoginRequest"] = 11] = "MediaPlaneLoginRequest";
    Message[Message["MobileToMediaPlaneLoginRequest"] = 12] = "MobileToMediaPlaneLoginRequest";
    Message[Message["MobileToMediaPlaneLogoutRequest"] = 13] = "MobileToMediaPlaneLogoutRequest";
    Message[Message["JsonToBinaryRequest"] = 14] = "JsonToBinaryRequest";
    Message[Message["JsonToBinaryResponse"] = 15] = "JsonToBinaryResponse";
    Message[Message["RepeaterLoginRequest"] = 16] = "RepeaterLoginRequest";
    Message[Message["WebClientLoginRequest"] = 17] = "WebClientLoginRequest";
    Message[Message["WebClientLoginResponse"] = 18] = "WebClientLoginResponse";
    Message[Message["WebClientLogoutRequest"] = 19] = "WebClientLogoutRequest";
    Message[Message["RepeaterBinaryResponse"] = 20] = "RepeaterBinaryResponse";
    Message[Message["RepeaterBroadcastBinaryResponse"] = 21] = "RepeaterBroadcastBinaryResponse";
    Message[Message["GenericBatchRequest"] = 22] = "GenericBatchRequest";
    Message[Message["GenericBatchResponse"] = 23] = "GenericBatchResponse";
    Message[Message["LateConnectPayloadRequest"] = 24] = "LateConnectPayloadRequest";
    Message[Message["LateConnectPayloadResponse"] = 25] = "LateConnectPayloadResponse";
    Message[Message["ShapeRequest"] = 26] = "ShapeRequest";
    Message[Message["ShapeResponse"] = 27] = "ShapeResponse";
    Message[Message["SlashRequest"] = 28] = "SlashRequest";
    Message[Message["SlashResponse"] = 29] = "SlashResponse";
    Message[Message["PlayerNameRequest"] = 30] = "PlayerNameRequest";
    Message[Message["PlayerNameResponse"] = 31] = "PlayerNameResponse";
    Message[Message["PhaseResponse"] = 32] = "PhaseResponse";
    Message[Message["GlobalInputResponse"] = 33] = "GlobalInputResponse";
    Message[Message["PlayerScoreResponse"] = 34] = "PlayerScoreResponse";
    Message[Message["PointTapRequest"] = 35] = "PointTapRequest";
    Message[Message["PointTapResetRequest"] = 36] = "PointTapResetRequest";
    Message[Message["ButtonRequest"] = 37] = "ButtonRequest";
    Message[Message["ButtonResponse"] = 38] = "ButtonResponse";
    Message[Message["TIMPlayerInput"] = 39] = "TIMPlayerInput";
    Message[Message["TIMMappedAreaAdd"] = 40] = "TIMMappedAreaAdd";
    Message[Message["TIMMappedAreaUpdate"] = 41] = "TIMMappedAreaUpdate";
    Message[Message["TIMMappedAreaRemoved"] = 42] = "TIMMappedAreaRemoved";
    Message[Message["TIMInteractableData"] = 43] = "TIMInteractableData";
    Message[Message["TIMInteractableUpdate"] = 44] = "TIMInteractableUpdate";
    Message[Message["TIMInteractableDestroyed"] = 45] = "TIMInteractableDestroyed";
    Message[Message["TIMHitEvent"] = 46] = "TIMHitEvent";
    Message[Message["TIMInputInteractable"] = 47] = "TIMInputInteractable";
    Message[Message["TIMPlayerInputInteractable"] = 48] = "TIMPlayerInputInteractable";
    Message[Message["AdminSetBotCount"] = 49] = "AdminSetBotCount";
    Message[Message["AdminSetInputType"] = 50] = "AdminSetInputType";
    Message[Message["AdminStartGame"] = 51] = "AdminStartGame";
    Message[Message["AdminSkipPhase"] = 52] = "AdminSkipPhase";
    Message[Message["AdminModifyAsteroidSpeed"] = 53] = "AdminModifyAsteroidSpeed";
    Message[Message["AdminModifyAsteroidHealth"] = 54] = "AdminModifyAsteroidHealth";
    Message[Message["AdminSetStartingPhase"] = 55] = "AdminSetStartingPhase";
...
function unionToMessage(type, accessor) {
    switch (Message[type]) {
        ...
        case 'ClientLoginRequest': return accessor(new client_login_request_js_1.ClientLoginRequest());
        ...
        case 'LateConnectPayloadRequest': return accessor(new late_connect_payload_request_js_1.LateConnectPayloadRequest());
        case 'LateConnectPayloadResponse': return accessor(new late_connect_payload_response_js_1.LateConnectPayloadResponse());
        ...
        case 'SlashRequest': return accessor(new slash_request_js_1.SlashRequest());
        case 'SlashResponse': return accessor(new slash_response_js_1.SlashResponse());
        ...
        case 'ButtonRequest': return accessor(new button_request_js_1.ButtonRequest());
        case 'ButtonResponse': return accessor(new button_response_js_1.ButtonResponse());
...
function unionListToMessage(type, accessor, index) {
    switch (Message[type]) {
        ...
        case 'ClientLoginRequest': return accessor(index, new client_login_request_js_1.ClientLoginRequest());
        ...
        case 'LateConnectPayloadRequest': return accessor(index, new late_connect_payload_request_js_1.LateConnectPayloadRequest());
        case 'LateConnectPayloadResponse': return accessor(index, new late_connect_payload_response_js_1.LateConnectPayloadResponse());
        ...
        case 'SlashRequest': return accessor(index, new slash_request_js_1.SlashRequest());
        case 'SlashResponse': return accessor(index, new slash_response_js_1.SlashResponse());
        ...
        case 'ButtonRequest': return accessor(index, new button_request_js_1.ButtonRequest());
        case 'ButtonResponse': return accessor(index, new button_response_js_1.ButtonResponse());
