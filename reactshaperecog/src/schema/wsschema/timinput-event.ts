...
import { ETriggerState } from '../wsschema/etrigger-state.js';
...
static createTIMInputEvent(builder:flatbuffers.Builder, area_handle: number, index: number, location_x: number, location_y: number, event_type: ETriggerState, time: number):flatbuffers.Offset {
  builder.prep(4, 24);
