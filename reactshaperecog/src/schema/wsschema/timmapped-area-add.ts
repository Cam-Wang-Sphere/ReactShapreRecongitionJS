...
export class TIMMappedAreaAdd {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TIMMappedAreaAdd {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTIMMappedAreaAdd(bb:flatbuffers.ByteBuffer, obj?:TIMMappedAreaAdd):TIMMappedAreaAdd {
  return (obj || new TIMMappedAreaAdd()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTIMMappedAreaAdd(bb:flatbuffers.ByteBuffer, obj?:TIMMappedAreaAdd):TIMMappedAreaAdd {
...
static startTIMMappedAreaAdd(builder:flatbuffers.Builder) {
...
static endTIMMappedAreaAdd(builder:flatbuffers.Builder):flatbuffers.Offset {
