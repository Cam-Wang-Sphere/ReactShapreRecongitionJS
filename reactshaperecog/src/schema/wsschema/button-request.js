...
var ButtonRequest = /** @class */ (function () {
    ...
    ButtonRequest.prototype.buttonInput = function () {
        ...
        return offset ? this.bb.readUint8(this.bb_pos + offset) : button_type_enum_js_1.ButtonTypeEnum.None;
    };
    ...
    ButtonRequest.addButtonInput = function (builder, buttonInput) {
        builder.addFieldInt8(1, buttonInput, button_type_enum_js_1.ButtonTypeEnum.None);
    };
